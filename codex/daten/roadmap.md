...
- [x] Wartungscheck am 2025-10-25: Tests (`npm test` erfolgreich, `pytest codex/tests` keine Tests gefunden, `flutter test` fehlgeschlagen: Testverzeichnis nicht gefunden)
